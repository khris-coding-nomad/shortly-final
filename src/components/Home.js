...
const Home = () => (
  <div className="py-20 sm:pt-16 lg:pt-16 justify-center">
    <div className="mx-auto max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-8">
      <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:px-0 md:text-left">
